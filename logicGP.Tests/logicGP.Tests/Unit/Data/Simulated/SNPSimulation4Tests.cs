...
public sealed class SNPSimulationTests
{
    ...
    {
        var trainer = new LogicGpRlcwMulticlassTrainer<BinaryClassificationOutput>(12,12,maxIndividuals:1000,folds:5,minMaxWeight:1.1);
    ...
    [TestMethod]
    public void TestSimulation2RlRw()
    {
        var trainer = new LogicGpRlcwMulticlassTrainer<BinaryClassificationOutput>(12,12,maxIndividuals:1000,folds:5,minMaxWeight:1.1);
    ...
    [TestMethod]
    public void TestSimulation3RlRw()
    {
        var trainer = new LogicGpRlcwMulticlassTrainer<BinaryClassificationOutput>(12,12,maxIndividuals:1000,folds:5,minMaxWeight:1.05,usedMetric:(ClassMetric.F1,Averaging.Macro));
        ...
        IEstimator<ITransformer> trainer)
    {
        ...
        for (var j = 1; j < 101; j++)
        {
            ...
            writer.Flush();
            if (trainer is IInterpretableTrainer it)
            {
                var model = it.Model;
